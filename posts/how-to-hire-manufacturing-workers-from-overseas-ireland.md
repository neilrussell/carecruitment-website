---
title: "How to Hire Manufacturing Workers from Overseas in Ireland"
description: "Which factory and food-processing roles can be sponsored on a DETE permit? An employer's guide to eligible roles, salary floors, and the full 6-month hiring process."
date: 2026-06-11
updated: 2026-06-11
category: Sector Hiring
readTime: "10 min"
slug: how-to-hire-manufacturing-workers-from-overseas-ireland
breadcrumb: Hiring Manufacturing Workers
waText: "Hi Monette, I run a manufacturing or food-processing business and I want to know which roles I can hire from overseas. Can you help?"
sidebarCta: "Need overseas workers for your factory or food plant? Ask Monette which roles qualify — free, no obligation."
image: /images/social/how-to-hire-farm-workers-from-overseas-ireland-post.png
imageAlt: "Irish employer guide to hiring overseas manufacturing and food processing workers on a DETE employment permit"
layout: blog-post.njk
permalink: /blog/how-to-hire-manufacturing-workers-from-overseas-ireland/index.html
toc:
  - { id: "can-you-hire", label: "Can manufacturing companies hire overseas?" }
  - { id: "which-roles-eligible", label: "Which roles are eligible?" }
  - { id: "ineligible-roles", label: "Roles that are NOT eligible" }
  - { id: "salary-requirements", label: "Salary requirements" }
  - { id: "the-process", label: "How the process works" }
  - { id: "timeline-costs", label: "Timeline and costs" }
  - { id: "50-50-rule", label: "The 50/50 rule for manufacturers" }
  - { id: "faq", label: "Frequently asked questions" }
related:
  - { url: "/blog/hiring-non-eu-workers-ireland-guide/", label: "Hiring non-EU workers in Ireland — full guide" }
  - { url: "/blog/minimum-salary-overseas-worker-ireland/", label: "Minimum salary for an overseas worker in Ireland" }
  - { url: "/blog/gep-vs-csep-which-permit/", label: "GEP vs CSEP — which permit is right?" }
faq:
  - q: "Can Irish manufacturing companies hire workers from outside the EU?"
    a: "Yes, but only for specific roles. General factory operatives fall on DETE's ineligible list, meaning you cannot get a permit for those positions regardless of how long you advertise. However, there are named exceptions that many employers miss: meat processor operatives, meat deboners, and CNC (Computer Numerical Control) operatives across most production sectors are all eligible for a General Employment Permit. Skilled technical roles — production technicians, quality engineers, toolmakers, maintenance engineers — are eligible under the standard GEP conditions."
  - q: "Are factory operatives eligible for an employment permit in Ireland?"
    a: "Not as a general rule. DETE classifies 'Food, drink and tobacco process operatives' and similar categories as ineligible. The reasoning is that these are roles the labour market should be able to fill domestically. The exceptions are specific and named: meat processor operatives (including deboners), and CNC operatives in sectors including glass, ceramics, textiles, chemical, rubber, plastics, and metal manufacturing. If your role is not in one of these exception categories, you will not be able to get a permit."
  - q: "What is the minimum salary for an overseas manufacturing worker in Ireland?"
    a: "It depends on the role. For most manufacturing and production roles eligible under the General Employment Permit, the minimum annual remuneration is €36,605. Meat processor operatives and meat deboners qualify for the reduced agri-food rate of €32,691 per year, based on a minimum hourly rate of €16.12. If the worker will be on a 40-hour week rather than 39 hours, the annual minimum rises to €33,529.60. These are the minimum figures — you must pay at or above them for the permit application to be approved."
  - q: "How long does it take to hire a manufacturing worker from overseas?"
    a: "Plan for around six months from your first conversation to the worker's first day. The Labour Market Needs Test runs for 28 days. DETE permit processing is currently running at around 11 to 12 weeks. The employment D-visa adds a further 4 to 8 weeks, and then there is travel and onboarding. Some of these stages overlap. The most important thing is to start early — the permit does not begin processing until the LMNT is complete."
  - q: "Does the 50/50 rule apply to manufacturing companies?"
    a: "Yes. Under Irish employment permit law, at least 50% of your workforce must be EEA nationals before a permit will be issued. For most established manufacturers this is not a problem, but it is worth checking the ratio before you apply, particularly if you have already sponsored several non-EEA workers. The main exceptions to this rule are sole-employee situations and start-ups within two years that hold a formal letter of support from Enterprise Ireland or IDA Ireland."
---
...
- DETE permit processing: 11 to 12 weeks (current average)
...
**Can Irish manufacturing companies hire workers from outside the EU?**
...
**Are factory operatives eligible for an employment permit in Ireland?**
Not as a general rule. DETE classifies most food and production operative categories as ineligible. The exceptions are specific and named: meat processor operatives (including deboners), and CNC operatives in sectors including glass, ceramics, textiles, chemical, rubber, plastics, and metal manufacturing. If your role is not in one of those exception categories, a permit will not be issued.

**What is the minimum salary for an overseas manufacturing worker in Ireland?**
...
**How long does it take to hire a manufacturing worker from overseas?**
Plan for around six months from start to a worker's first day. The Labour Market Needs Test runs for 28 days, DETE processing is currently around 11 to 12 weeks, and the employment D-visa adds another 4 to 8 weeks. Start the process before you are under pressure — the permit cannot be submitted until the advertising period is complete.
