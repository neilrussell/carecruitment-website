---
title: "The Reactivation Employment Permit: An Irish Employer's Guide (2026)"
description: "What the Reactivation Employment Permit is, who it's for, and when an Irish employer can use it to legally re-employ a worker who fell out of the permit system through no fault of their own."
date: 2026-06-30
updated: 2026-06-30
category: Employment Permits
readTime: "9 min"
slug: reactivation-employment-permit-ireland-employer-guide
breadcrumb: Reactivation Employment Permit Guide
waText: "Hi Monette, I've a worker who fell out of the permit system and I want to re-employ them legally. Can you tell me if a Reactivation Employment Permit applies?"
sidebarCta: "Got a worker who lost their permit status through no fault of their own? We'll tell you whether a Reactivation Employment Permit is the route — ask Monette."
image: /images/social/gep-vs-csep-approved.png
imageAlt: "Irish employer's guide to the Reactivation Employment Permit — who qualifies, the salary floor, the Stamp 1 letter, and when it applies"
layout: blog-post.njk
permalink: /blog/reactivation-employment-permit-ireland-employer-guide/index.html
toc:
  - { id: "what-it-is", label: "What the Reactivation permit actually is" }
  - { id: "who-its-for", label: "Who it's for — and who it isn't" }
  - { id: "stamp-1-first", label: "The Stamp 1 letter comes first" }
  - { id: "employer-criteria", label: "What you have to meet as the employer" }
  - { id: "salary", label: "Salary, hours and occupations" }
  - { id: "not-a-hiring-permit", label: "Why it isn't an overseas-hiring permit" }
  - { id: "application", label: "How the application works" }
  - { id: "duration", label: "Duration, renewal and Stamp 4" }
...
related:
  ...
  - { url: "/blog/intra-company-transfer-employment-permit-ireland-employer-guide/", label: "The Intra-Company Transfer permit guide" }
faq:
  - q: "What is the Reactivation Employment Permit in Ireland?"
    a: "The Reactivation Employment Permit lets a foreign national who once held a valid Irish employment permit, but fell out of the system through no fault of their own — or who was badly treated or exploited at work — go back to working legally. It's a route to regularise someone who is already in Ireland and lost their permit status, not a way to hire a new worker from overseas. The worker has to first get a temporary Stamp 1 and a Reactivation Employment Permit support letter from the Department of Justice before the permit application can be made to the Department of Enterprise, Trade and Employment."
  - q: "Who can apply for a Reactivation Employment Permit?"
    a: "Either the worker or the employer can submit the application. The permit is issued to the worker, and a certified copy goes to the employer. Before any of that, the worker must have applied to Immigration Service Delivery and be holding a temporary Stamp 1 immigration permission together with a Reactivation Employment Permit letter from the Department of Justice. Without that letter, the permit application can't proceed."
  - q: "What is the minimum salary for a Reactivation Employment Permit?"
    a: "The remuneration has to be at least the National Minimum Wage, which is €14.15 an hour as of January 2026. There's no separate higher salary threshold the way there is for the General Employment Permit. The job still has to be a real role with real hours, and the pay has to be at or above the legal minimum for that work — some sectors have their own legally binding rates that sit above the National Minimum Wage."
  - q: "Does the Reactivation Employment Permit need a Labour Market Needs Test?"
    a: "No. The Reactivation Employment Permit does not require a Labour Market Needs Test, so you don't have to advertise the role on Jobs Ireland and EURES first. That's one of the few ways it's simpler than the General Employment Permit. The 50/50 rule still applies, though — at least half your employees have to be EEA nationals, unless you'd be the worker's sole employee."
  - q: "Can I use a Reactivation permit to hire a worker from the Philippines?"
    a: "No. The Reactivation Employment Permit is only for someone already in Ireland who previously held an employment permit and fell out of the system. If you want to hire a worker from the Philippines who has never worked in Ireland, that's a General Employment Permit or a Critical Skills Employment Permit. We confirm which permit fits before any application goes in — applying for the wrong one just costs you time."
  - q: "How long does a Reactivation Employment Permit last?"
    a: "A first permit is granted for up to 24 months. It can then be renewed for up to a further three years. Once the worker has been in employment permit employment for five years or more, they can usually apply to Immigration Service Delivery for Stamp 4 permission, which lets them work without a permit at all. The worker also has to stay with the employer named on the permit for the first 12 months, except in cases of redundancy or genuinely unforeseen circumstances."
---

<p>The Reactivation Employment Permit is one most employers have never heard of, and for good reason — it solves a narrow problem. It exists for a worker who was already in Ireland legally on a permit, then lost that status through no fault of their own, and now needs a way back to legal employment.</p>

<p>If that describes someone you want to employ — a worker whose previous employer let their permit lapse, or who was exploited and walked away — this is the permit that can put them back on a legal footing. If you're an employer looking to bring in a worker from overseas, it isn't your permit, and this guide will tell you what is. We'll cover both.</p>

## What the Reactivation permit actually is {#what-it-is}
...
## Who it's for — and who it isn't {#who-its-for}
...
- have already had the benefit of the scheme once;
- came to Ireland as a student or visitor and never held an employment permit;
- held only a temporary permit — an Intra-Company Transfer, a Contract for Services, or an Internship permit;
- left the State at any point; or
- changed their immigration status away from Stamp 1.
...
## The Stamp 1 letter comes first {#stamp-1-first}
...
## What you have to meet as the employer {#employer-criteria}
...
## Salary, hours and occupations {#salary}
...
## Why it isn't an overseas-hiring permit {#not-a-hiring-permit}
...
For that situation, the route is almost always the <a href="/blog/hiring-general-employment-permit-ireland-2026/">General Employment Permit</a>, or the <a href="/blog/critical-skills-employment-permit-employer-guide-2026/">Critical Skills Employment Permit</a> if the role and salary qualify. Those are the permits built for hiring a non-EEA worker into a new Irish job. The Reactivation permit sits in a different category entirely — it fixes a broken status, it doesn't fill a vacancy from abroad.

So the filter is short. Is the worker already in Ireland, did they hold an employment permit before, and did they lose it through no fault of their own? If yes, Reactivation is worth looking at. If the person is overseas, you need a <a href="/blog/hiring-non-eu-workers-ireland-guide/">different permit</a>, and applying for Reactivation will only waste the weeks it takes to be refused.
...
4. **DETE processes it.** The application goes into the processing queue and is decided in date order; a decision-maker may ask for more information. Our <a href="/blog/employment-permit-processing-times-ireland-employer-tracker/">live processing-times tracker</a> shows where the queue stands now.
...
## Duration, renewal and Stamp 4 {#duration}
...
Most of what we do is the <a href="/blog/hiring-general-employment-permit-ireland-2026/">General Employment Permit</a> route — placing Filipino workers with Irish employers and running the application from start to finish. Monette is Filipino, based in Tipperary, and went through the Irish permit system herself, so none of this is theory to us.
...
<h2>Not sure if a Reactivation permit <span>applies to your worker?</span></h2>
<p>Free consultation. We confirm whether it's a Reactivation Employment Permit or a General Employment Permit before you apply, then run the whole application.</p>
<div class="cta-btns">
